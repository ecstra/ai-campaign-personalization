...
export default function Login() {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-background relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,oklch(0.52_0.12_30/0.04),transparent_50%),radial-gradient(circle_at_70%_80%,oklch(0.52_0.12_30/0.03),transparent_50%)]" />

            ...
            <div className="relative z-10 w-full max-w-sm mx-6">
                ...
                <div className="flex items-center justify-center gap-3 mb-10">
                    <div className="rounded-full bg-primary p-2.5 shadow-md flex items-center justify-center">
                        <span className="material-symbols-rounded text-primary-foreground" style={{ fontSize: '20px', transform: 'rotate(-45deg) translateX(8%)' }}>send</span>
                    </div>
                ...
                <div className="bg-card border rounded-lg p-8 shadow-lg">
                    ...
                    >
                        <svg className="mr-2.5 h-4 w-4" viewBox="0 0 24 24">
                            <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="var(--google-blue)" />
